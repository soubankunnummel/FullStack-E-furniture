...
export default function Banner() {
  ...
  <div className="container mt-5 ttd">
  <div className="row">
    <div className="col-md-4 col-sm-12 text-center text-join">
      <div className="text-area">
        <h3 className="fw-bold textJoin">Join us at Climate Week NYC 2023</h3>
        <div className="para">
          <p>
            As part of our commitment to sustainability, we’re hosting the Action Speaks Summit during Climate Week NYC. Join us on 9/23 for a free public talk with a climate-conscious fashion designer and a live comedy show. Space is limited, sign up now!
          </p>
        </div>
      </div>
    </div>
    <div className="col-md-8 col-sm-12 text-join">
      <div className="image">
        <img
